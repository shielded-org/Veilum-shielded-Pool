...
export function normalizeSeedToBytes32(seedInput) {
    if (/^0x[0-9a-fA-F]{64}$/.test(seedInput))
        return seedInput;
...
export function deriveDeterministicScalar(seedBytes32, label, modulus) {
...
export function buildDeterministicUsers(seedBytes32) {
