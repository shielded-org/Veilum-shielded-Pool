...
export declare function loadCircuitArtifact(circuitsDir?: string): {
    bytecode: string;
    abi: unknown;
};
export declare function generateUltraHonkProof(inputs: ProofInputs, circuitsDir?: string): Promise<{
    proofBytes: Buffer;
    publicInputsBytes: Buffer;
}>;
export declare function stripPublicInputsFromProof(proofWithPublicInputs: Buffer): Buffer;
